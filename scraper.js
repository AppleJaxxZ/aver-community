...
const scraper = async(pinNum, dateOfB, phoneNumber) => {


    // const pinNum = localStorage.getItem('pin');
    // const dateOfB =  localStorage.getItem('dob');
  ...
  async function getImageText() {
    ...
    sendSMS(textResult, phoneNumber);
